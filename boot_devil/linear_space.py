...
class NeuralNetwork(nn.Module):
    ...
    def train_devil(self,model):
    	...
    	y_train=torch.from_numpy(numpy.random.rand(100,100).astype('float32'))
...
for i in range(10):
	...
	print(numpy.array(devil_sub.devil_high_ras([i for i in zip(range(0,100),numpy.array(torch.sin(devil)))])).reshape(10,10))
